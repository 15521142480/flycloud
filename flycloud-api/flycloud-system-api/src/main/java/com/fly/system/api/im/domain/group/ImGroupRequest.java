package com.fly.system.api.im.domain.group;
 ...
 *     <li>处理：群主 / 管理员调 agree / refuse 推进状态机；同意时把 addSource / inviterUserId 同步写入 {@link ImGroupMember}</li>
 * </ul>
 *
 * @author lxs
 * @date 2026-07-02
...
@NoArgsConstructor
@AllArgsConstructor
public class ImGroupRequest extends BaseEntity {
     ...
     * 加入来源
     * <p>
     * 枚举 {@link ImGroupAddSourceEnum}；同意时同步写入 {@link ImGroupMember#getAddSource()}
     */
