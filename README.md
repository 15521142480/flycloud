...
| jdk8            | jdk8归档分支                                     | jdk8  | <nobr>vue2 + vue3<nobr> |   
...
| 功能               | 描述                                           |
|------------------|----------------------------------------------|
| 登录页              | 采用【图文点选验证码】实现登录接口的安全验证、密码端到端加密等              |
| 首页               | 统计当前用户整个业务报表统计、OA流程的代办事项、通知等                 |
| <nobr>用户管理<nobr> | 主要对系统操作的用户进行配置                               |
...
| 功能列表                 | 功能描述                                                                                | 是否完成 |
|----------------------|-------------------------------------------------------------------------------------|------|
| <nobr>BPMN 设计器<nobr> | 基于 BPMN 标准开发，适配复杂业务场景，满足多层级审批及流程自动化需求                                               | ✅    |
