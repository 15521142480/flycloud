...
@RestController
@RequestMapping("/processInstanceCopy")
public class BpmProcessInstanceCopyController extends BaseController {

    private final IBpmProcessInstanceCopyService processInstanceCopyService;
    ...
    public R<PageVo<BpmProcessInstanceCopyRespVO>> list(BpmProcessInstanceCopyBo bo, PageBo page) {
        ...
        PageVo<BpmProcessInstanceCopy> pageData = processInstanceCopyService.getProcessInstanceCopyPageByEntity(
