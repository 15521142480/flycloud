...
import com.fly.bpm.flowable.behavior.BpmActivityBehaviorFactory;
...
public class BpmFlowableConfiguration {
    ...
    @Bean
    @SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection") // ISysUserProvider 可以注入成功
    public BpmTaskCandidateInvoker bpmTaskCandidateInvoker(List<BpmTaskCandidateStrategy> strategyList,
        ...
        return new BpmTaskCandidateInvoker(strategyList, sysUserProvider);
    }
