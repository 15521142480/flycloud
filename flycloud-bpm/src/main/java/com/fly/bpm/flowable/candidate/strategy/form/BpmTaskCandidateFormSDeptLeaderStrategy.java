...
import com.fly.bpm.flowable.candidate.strategy.dept.AbstractBpmTaskCandidateDeptLeaderStrategy;
...
/**
 * 表单内部门负责人 {@link com.fly.bpm.flowable.candidate.BpmTaskCandidateStrategy} 实现类
 *
 * @author jason
 */
@Component
