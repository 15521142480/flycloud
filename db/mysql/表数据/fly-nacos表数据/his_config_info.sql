INSERT INTO nacos.his_config_info (id, nid, data_id, group_id, app_name, content, md5, gmt_create, gmt_modified, src_user, src_ip, op_type, tenant_id) VALUES (283, 81, 'nacos.cfg.dataIdfoo', 'foo', '', 'helloWorld', '1a833da63a6b7e20098dae06d06602e1', '2026-02-05 00:35:50', '2026-02-05 00:35:51', null, '85.121.48.111', 'U', '');
INSERT INTO nacos.his_config_info (id, nid, data_id, group_id, app_name, content, md5, gmt_create, gmt_modified, src_user, src_ip, op_type, tenant_id) VALUES (283, 82, 'nacos.cfg.dataIdfoo', 'foo', '', 'helloWorld', '1a833da63a6b7e20098dae06d06602e1', '2026-02-11 20:14:53', '2026-02-11 20:14:53', null, '85.121.48.111', 'U', '');
INSERT INTO nacos.his_config_info (id, nid, data_id, group_id, app_name, content, md5, gmt_create, gmt_modified, src_user, src_ip, op_type, tenant_id) VALUES (283, 83, 'nacos.cfg.dataIdfoo', 'foo', '', 'helloWorld', '1a833da63a6b7e20098dae06d06602e1', '2026-02-19 06:21:37', '2026-02-19 06:21:37', null, '85.121.48.111', 'U', '');
INSERT INTO nacos.his_config_info (id, nid, data_id, group_id, app_name, content, md5, gmt_create, gmt_modified, src_user, src_ip, op_type, tenant_id) VALUES (283, 84, 'nacos.cfg.dataIdfoo', 'foo', '', 'helloWorld', '1a833da63a6b7e20098dae06d06602e1', '2026-02-25 10:31:07', '2026-02-25 10:31:06', null, '85.120.228.180', 'U', '');
INSERT INTO nacos.his_config_info (id, nid, data_id, group_id, app_name, content, md5, gmt_create, gmt_modified, src_user, src_ip, op_type, tenant_id) VALUES (29, 85, 'application-datasource.yaml', 'DEFAULT_GROUP', '', '
# 数据源连接 配置
datasource:
...
mybatis-encryptor:
  ...
  publicKey:
  privateKey:
  ', 'cb37d127d7d0373d48141eea4cf3fe93', '2026-03-03 06:49:21', '2026-03-03 06:49:21', 'nacos', '183.9.105.135', 'U', '');
