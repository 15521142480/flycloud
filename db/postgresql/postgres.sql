...
-- 用户管理按钮
insert into sys_menu values('1001', '用户查询', '100', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:user:list',          '#', 'admin', now(), '', null, '');
...
-- 角色管理按钮
insert into sys_menu values('1008', '角色查询', '101', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:role:list',          '#', 'admin', now(), '', null, '');
...
-- 菜单管理按钮
insert into sys_menu values('1013', '菜单查询', '102', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:menu:list',          '#', 'admin', now(), '', null, '');
...
-- 部门管理按钮
insert into sys_menu values('1017', '部门查询', '103', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:dept:list',          '#', 'admin', now(), '', null, '');
...
-- 岗位管理按钮
insert into sys_menu values('1021', '岗位查询', '104', '1',  '', '', '', '1', '0', 'F', '0', '0', 'system:post:list',          '#', 'admin', now(), '', null, '');
...
-- 字典管理按钮
insert into sys_menu values('1026', '字典查询', '105', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:dict:list',          '#', 'admin', now(), '', null, '');
...
-- 参数设置按钮
insert into sys_menu values('1031', '参数查询', '106', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:config:list',        '#', 'admin', now(), '', null, '');
...
-- 通知公告按钮
insert into sys_menu values('1036', '公告查询', '107', '1', '#', '', '', '1', '0', 'F', '0', '0', 'system:notice:list',        '#', 'admin', now(), '', null, '');
...
-- 操作日志按钮
insert into sys_menu values('1040', '操作查询', '500', '1', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:operlog:list',      '#', 'admin', now(), '', null, '');
...
-- 在线用户按钮
insert into sys_menu values('1046', '在线查询', '109', '1', '#', '', '', '1', '0', 'F', '0', '0', 'monitor:online:list',       '#', 'admin', now(), '', null, '');
...
-- 代码生成按钮
insert into sys_menu values('1055', '生成查询', '115', '1', '#', '', '', '1', '0', 'F', '0', '0', 'tool:gen:list',             '#', 'admin', now(), '', null, '');
...
-- ----------------------------
-- 数字化加工统计厂库表 (档案统计/业务统计)
-- ----------------------------
drop table if exists digital_process_statistic;
create table if not exists digital_process_statistic(
    "id" serial4 NOT NULL,
    "sjgsdwdm" varchar,
    "bgdwdm" varchar,
    "gddwdm" varchar,
    ...
    "dh_id" int4 NOT NULL,
    "dh" varchar NOT NULL,
    "ydh" varchar NOT NULL,

    "jgjs_count_sj" int4 DEFAULT 0,
    "jgjs_count_bg" int4 DEFAULT 0,
    "jgjs_count_gd" int4 DEFAULT 0,

    "fmys_count_sj" int4 DEFAULT 0,
    "fmys_count_bg" int4 DEFAULT 0,
    "fmys_count_gd" int4 DEFAULT 0,

    "mlys_count_sj" int4 DEFAULT 0,
    "mlys_count_bg" int4 DEFAULT 0,
    "mlys_count_gd" int4 DEFAULT 0,

    "bkbys_count_sj" int4 DEFAULT 0,
    "bkbys_count_bg" int4 DEFAULT 0,
    "bkbys_count_gd" int4 DEFAULT 0,

    "fy_count_sj" int4 DEFAULT 0,
    "fy_count_bg" int4 DEFAULT 0,
    "fy_count_gd" int4 DEFAULT 0,

    "clys_count_sj" int4 DEFAULT 0,
    "clys_count_bg" int4 DEFAULT 0,
    "clys_count_gd" int4 DEFAULT 0,

    "zys_count_sj" int4 DEFAULT 0,
    "zys_count_bg" int4 DEFAULT 0,
    "zys_count_gd" int4 DEFAULT 0,

    "jzzls_count_sj" int4 DEFAULT 0,
    "jzzls_count_bg" int4 DEFAULT 0,
    "jzzls_count_gd" int4 DEFAULT 0,

    "ywzls_count_sj" int4 DEFAULT 0,
    "ywzls_count_bg" int4 DEFAULT 0,
    "ywzls_count_gd" int4 DEFAULT 0,

    "clzls_count_sj" int4 DEFAULT 0,
    "clzls_count_bg" int4 DEFAULT 0,
    "clzls_count_gd" int4 DEFAULT 0,

    "ybcls_count_sj" int4 DEFAULT 0,
    "ybcls_count_bg" int4 DEFAULT 0,
    "ybcls_count_gd" int4 DEFAULT 0,

    "jz_createtime" timestamp(6),
    "createtime" timestamp(6)
    );

-- 索引
CREATE INDEX "d_ps_sjgsdwdm_index" ON "digital_process_statistic" USING btree (
    "sjgsdwdm" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
    );
CREATE INDEX "d_ps_bgdwdm_index" ON "digital_process_statistic" USING btree (
    "bgdwdm" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
    );
CREATE INDEX "d_ps_gddwdm_index" ON "digital_process_statistic" USING btree (
    "gddwdm" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
    );

-- 注释
COMMENT ON TABLE "digital_process_statistic" IS '数字化加工统计(仓库)表';

COMMENT ON COLUMN "digital_process_statistic"."id" IS '主键';
COMMENT ON COLUMN "digital_process_statistic"."sjgsdwdm" IS '统计部门-数据归属单位)';
COMMENT ON COLUMN "digital_process_statistic"."bgdwdm" IS '统计部门-保管单位';
COMMENT ON COLUMN "digital_process_statistic"."gddwdm" IS '统计部门-归档单位';
COMMENT ON COLUMN "digital_process_statistic"."jzlbdm" IS '卷宗类别代码';
COMMENT ON COLUMN "digital_process_statistic"."new_jzlbdm" IS '卷宗类别代码（新）';
COMMENT ON COLUMN "digital_process_statistic"."dh_id" IS '档号id';
COMMENT ON COLUMN "digital_process_statistic"."dh" IS '卷宗编码(即档号dh)';
COMMENT ON COLUMN "digital_process_statistic"."ydh" IS '原档号';

COMMENT ON COLUMN "digital_process_statistic"."jgjs_count_sj" IS '加工卷数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."jgjs_count_bg" IS '加工卷数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."jgjs_count_gd" IS '加工卷数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."fmys_count_sj" IS '封面页数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."fmys_count_bg" IS '封面页数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."fmys_count_gd" IS '封面页数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."mlys_count_sj" IS '目录页数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."mlys_count_bg" IS '目录页数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."mlys_count_gd" IS '目录页数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."bkbys_count_sj" IS '备考表页数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."bkbys_count_bg" IS '备考表页数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."bkbys_count_gd" IS '备考表页数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."fy_count_sj" IS '副页 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."fy_count_bg" IS '副页 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."fy_count_gd" IS '副页 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."clys_count_sj" IS '材料页数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."clys_count_bg" IS '材料页数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."clys_count_gd" IS '材料页数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."zys_count_sj" IS '总页数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."zys_count_bg" IS '总页数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."zys_count_gd" IS '总页数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."jzzls_count_sj" IS '卷宗著录数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."jzzls_count_bg" IS '卷宗著录数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."jzzls_count_gd" IS '卷宗著录数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."ywzls_count_sj" IS '业务著录数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."ywzls_count_bg" IS '业务著录数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."ywzls_count_gd" IS '业务著录数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."clzls_count_sj" IS '材料著录数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."clzls_count_bg" IS '材料著录数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."clzls_count_gd" IS '材料著录数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."ybcls_count_sj" IS '一般材料数 (数据)';
COMMENT ON COLUMN "digital_process_statistic"."ybcls_count_bg" IS '一般材料数 (保管)';
COMMENT ON COLUMN "digital_process_statistic"."ybcls_count_gd" IS '一般材料数 (归档)';

COMMENT ON COLUMN "digital_process_statistic"."jz_createtime" IS '卷宗创建时间';
COMMENT ON COLUMN "digital_process_statistic"."createtime" IS '创建时间';
