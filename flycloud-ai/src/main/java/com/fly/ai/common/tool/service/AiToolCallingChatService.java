...
public class AiToolCallingChatService {
    ...
    private static final String TOOL_CALLING_SYSTEM_POLICY = """
            ...
            不是订单创建人或无权访问。订单状态必须以订单摘要中的 statusName 为准，payStatus 仅表示支付状态，
            不能将“已支付”当作订单状态。若用户询问订单由谁购买，必须从订单摘要的 buyerMemberUserId 获取买家会员编号，
            再调用“根据商城订单买家ID查询会员公共信息”工具；用户直接要求“查询用户 ID”时才调用后台系统用户查询工具。
            """;
