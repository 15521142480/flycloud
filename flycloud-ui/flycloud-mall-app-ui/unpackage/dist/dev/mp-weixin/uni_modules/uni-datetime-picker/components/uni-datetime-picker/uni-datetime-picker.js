...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: $data.singleVal,
    e: common_vendor.o(($event) => $data.singleVal = $event.detail.value, "93")
  } : {
    f: common_vendor.p({
      type: "calendar",
      color: "#e1e1e1",
    ...
    i: common_vendor.o(($event) => $data.range.startDate = $event.detail.value, "fa"),
    j: common_vendor.t($props.rangeSeparator),
    k: $options.endPlaceholderText,
    l: $data.range.endDate,
    m: common_vendor.o(($event) => $data.range.endDate = $event.detail.value, "32")
  }, {
    ...
    p: common_vendor.o((...args) => $options.clear && $options.clear(...args), "c4")
  } : {}, {
    q: $props.disabled ? 1 : "",
    r: $props.border ? 1 : "",
    s: common_vendor.o((...args) => $options.show && $options.show(...args), "80"),
    t: $data.popup,
    v: common_vendor.o((...args) => $options.close && $options.close(...args), "30"),
    w: !$data.isPhone
    ...
    B: common_vendor.o(($event) => $data.tempSingleDate = $event.detail.value, "cf"),
    C: $options.selectTimeText,
    D: !$data.tempSingleDate,
    E: $data.time,
    F: common_vendor.o(($event) => $data.time = $event.detail.value, "3c"),
    G: common_vendor.o(($event) => $data.time = $event, "93"),
    H: common_vendor.p({
      type: "time",
      border: false,
    ...
    I: common_vendor.sr("pcSingle", "af2a097c-4"),
    J: common_vendor.o($options.singleChange, "7d"),
    K: common_vendor.p({
      showMonth: false,
    ...
    N: common_vendor.o((...args) => $options.confirmSingleChange && $options.confirmSingleChange(...args), "8a")
  } : {}, {
    ...
    S: common_vendor.o(($event) => $data.tempRange.startDate = $event.detail.value, "9e"),
    T: $options.startTimeText,
    U: !$data.tempRange.startDate,
    V: $data.tempRange.startTime,
    W: common_vendor.o(($event) => $data.tempRange.startTime = $event.detail.value, "2c"),
    X: common_vendor.o(($event) => $data.tempRange.startTime = $event, "18"),
    Y: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
      border: false,
    ...
    ac: common_vendor.o(($event) => $data.tempRange.endDate = $event.detail.value, "3e"),
    ad: $options.endTimeText,
    ae: !$data.tempRange.endDate,
    af: $data.tempRange.endTime,
    ag: common_vendor.o(($event) => $data.tempRange.endTime = $event.detail.value, "47"),
    ah: common_vendor.o(($event) => $data.tempRange.endTime = $event, "f5"),
    ai: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
      border: false,
    ...
    aj: common_vendor.sr("left", "af2a097c-8"),
    ak: common_vendor.o($options.leftChange, "c2"),
    al: common_vendor.o($options.updateRightCale, "5e"),
    am: common_vendor.o($options.leftMonthSwitch, "23"),
    an: common_vendor.p({
      showMonth: false,
      ["start-date"]: $data.caleRange.startDate,
      ["end-date"]: $data.caleRange.endDate,
    ...
    ao: common_vendor.sr("right", "af2a097c-9"),
    ap: common_vendor.o($options.rightChange, "ba"),
    aq: common_vendor.o($options.updateLeftCale, "ec"),
    ar: common_vendor.o($options.rightMonthSwitch, "4c"),
    as: common_vendor.p({
      showMonth: false,
      ["start-date"]: $data.caleRange.startDate,
      ["end-date"]: $data.caleRange.endDate,
    ...
    aw: common_vendor.o((...args) => $options.clear && $options.clear(...args), "ba"),
    ax: common_vendor.t($options.okText),
    ay: common_vendor.o((...args) => $options.confirmRangeChange && $options.confirmRangeChange(...args), "7c")
  } : {}, {
    az: common_vendor.s($data.popover)
  }), {
    aA: $data.popup
  }) : {}, {
    aB: common_vendor.sr("mobile", "af2a097c-10"),
    aC: $data.isPhone,
    aD: common_vendor.o($options.mobileChange, "60"),
    aE: common_vendor.p({
      clearDate: false,
      date: $data.defSingleDate,
