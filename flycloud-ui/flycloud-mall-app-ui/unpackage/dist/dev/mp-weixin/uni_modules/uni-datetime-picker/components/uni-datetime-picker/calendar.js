...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o((...args) => $options.clean && $options.clean(...args), "49")
  } : {}, {
    d: $props.insert || $data.show
  }, $props.insert || $data.show ? common_vendor.e({
    e: $props.left
  }, $props.left ? {
    f: common_vendor.o((...args) => $options.pre && $options.pre(...args), "2f")
  } : {}, {
    g: common_vendor.t(($data.nowDate.year || "") + " 年 " + ($data.nowDate.month || "") + " 月"),
    h: $props.date,
    i: common_vendor.o((...args) => $options.bindDateChange && $options.bindDateChange(...args), "94"),
    j: $props.right
  }, $props.right ? {
    k: common_vendor.o((...args) => $options.next && $options.next(...args), "82")
  } : {}, {
    l: !$props.insert
  }, !$props.insert ? {
    m: common_vendor.o((...args) => $options.clean && $options.clean(...args), "ce")
  } : {}, {
    n: !$props.insert ? 1 : "",
    o: $props.showMonth
  }, $props.showMonth ? {
    ...
    B: common_vendor.o(($event) => $data.time = $event, "cc"),
    C: common_vendor.p({
      type: "time",
    ...
    F: common_vendor.o(($event) => $data.timeRange.startTime = $event, "1e"),
    G: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
      border: false,
    ...
    J: common_vendor.o(($event) => $data.timeRange.endTime = $event, "59"),
    K: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
      border: false,
    ...
    M: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "98")
  } : {}, {
    N: !$props.insert ? 1 : "",
    O: $data.aniMaskShow ? 1 : "",
    P: $data.aniMaskShow ? 1 : ""
  }) : {}, {
    Q: common_vendor.o((...args) => $options.leaveCale && $options.leaveCale(...args), "9b")
  });
}
