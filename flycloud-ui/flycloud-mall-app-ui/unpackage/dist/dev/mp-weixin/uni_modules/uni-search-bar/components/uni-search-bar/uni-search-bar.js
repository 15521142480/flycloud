...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: $props.maxlength,
    g: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "e3"),
    h: common_vendor.o((...args) => $options.blur && $options.blur(...args), "01"),
    i: common_vendor.o((...args) => $options.emitFocus && $options.emitFocus(...args), "21"),
    j: $data.searchVal,
    k: common_vendor.o(($event) => $data.searchVal = $event.detail.value, "87")
  } : {
    ...
    o: common_vendor.o((...args) => $options.clear && $options.clear(...args), "b8")
  } : {}, {
    p: $props.radius + "px",
    q: $props.bgColor,
    r: common_vendor.o((...args) => $options.searchClick && $options.searchClick(...args), "7a"),
    ...
    v: common_vendor.o((...args) => $options.cancel && $options.cancel(...args), "2c")
  } : {});
}
