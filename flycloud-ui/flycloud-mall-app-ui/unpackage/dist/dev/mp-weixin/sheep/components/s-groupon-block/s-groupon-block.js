...
const sheep_api_promotion_combination = require("../../api/promotion/combination.js");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    async function getCombinationActivityDetailList(ids) {
      const { data } = await sheep_api_promotion_combination.CombinationApi.getCombinationActivityListByIds(ids);
      return data;
    }
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-17051e0b"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/sheep/components/s-groupon-block/s-groupon-block.js.map
