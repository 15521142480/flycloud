...
const _sfc_main = {
  ...
  data() {
    return {
      files: [],
      localValue: [],
      imgsrc: sheep_index.sheep.$url.static("/static/img/shop/upload-camera.png")
    };
  },
  watch: {
    modelValue: {
  ...
  created() {
    if (this.driver === "local") {
      common_vendor._r.chooseAndUploadFile = sheep_components_sUploader_chooseAndUploadFile.chooseAndUploadFile;
    }
  ...
  methods: {
    ...
    getPreviewFileUrl(value = "") {
      return sheep_index.sheep.$url.cdn(value);
    },
    ...
    async chooseFiles() {
      ...
      await sheep_components_sUploader_chooseAndUploadFile.chooseAndUploadFile({
        ...
        common_vendor.index.__f__("log", "at sheep/components/s-uploader/s-uploader.vue:391", "选择失败", err);
      });
    },
    /**
     * 选择文件回调
    ...
    uploadFiles(files) {
      ...
      return sheep_components_sUploader_chooseAndUploadFile.uploadCloudFiles.call(this, files, 5, (res) => {
        ...
        common_vendor.index.__f__("log", "at sheep/components/s-uploader/s-uploader.vue:454", err);
      });
    },
    /**
     * 成功或失败
     ...
     */
    delFile(index) {
      if (!common_vendor.isEmpty(this.files)) {
        this.$emit("delete", {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: $data.imgsrc,
    i: common_vendor.o($options.uploadFiles, "75"),
    j: common_vendor.o($options.choose, "60"),
    k: common_vendor.o($options.delFile, "61"),
    l: common_vendor.p({
    ...
    n: common_vendor.o($options.uploadFiles, "eb"),
    o: common_vendor.o($options.choose, "29"),
    p: common_vendor.o($options.delFile, "12"),
    q: common_vendor.p({
      readonly: $props.readonly,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-82f430bc"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/sheep/components/s-uploader/s-uploader.js.map
