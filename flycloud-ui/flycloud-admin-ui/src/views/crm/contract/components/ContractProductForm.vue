<template>
  ...
  >
    <el-table :data="formData" class="-mt-10px">
      ...
      <el-table-column
        :label="t('auto.views.crm.contract.components.ContractProductForm.kabc0ac79')"
        min-width="180"
      >
        <template #default="{ row, $index }">
          <el-form-item :prop="`${$index}.productId`" :rules="formRules.productId" class="mb-0px!">
            <el-select
              ...
              :placeholder="t('auto.views.crm.contract.components.ContractProductForm.k59a0d3d1')"
            >
              <el-option
      ...
      <el-table-column :label="t('extra.k3a50fbd4')" min-width="120">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('extra.k56e8fb09')" fixed="right" min-width="140">
        <template #default="{ row, $index }">
      ...
      <el-table-column
        :label="t('auto.views.erp.finance.payment.components.FinancePaymentItemForm.k92bcbf71')"
        prop="totalPrice"
        fixed="right"
        min-width="140"
      >
  ...
  <el-row justify="center" class="mt-3" v-if="!disabled">
    <el-button @click="handleAdd" round>{{ t('extra.k7a28b968') }}</el-button>
  </el-row>
</template>
...
const formRules = reactive({
  productId: [
    {
      required: true,
      message: t('auto.views.crm.contract.components.ContractProductForm.k0b3cde2b'),
      trigger: 'blur'
    }
  ],
  contractPrice: [
    {
      required: true,
      message: t('auto.views.crm.contract.components.ContractProductForm.kb1188606'),
      trigger: 'blur'
    }
  ],
  count: [
    {
      required: true,
      message: t('auto.views.crm.contract.components.ContractProductForm.k55ce5fbe'),
      trigger: 'blur'
    }
  ]
})
