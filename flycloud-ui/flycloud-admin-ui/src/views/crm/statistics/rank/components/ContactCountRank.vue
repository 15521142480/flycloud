...
<template>
  ...
  <el-card shadow="never" class="mt-16px">
    <el-table v-loading="loading" :data="list">
      <el-table-column
        :label="t('auto.views.crm.statistics.rank.components.ContactCountRank.k92040fc1')"
        align="center"
        type="index"
        width="80"
      />
      ...
      />
      <el-table-column
        :label="t('auto.views.crm.statistics.rank.components.ContactCountRank.k91061a56')"
        align="center"
        prop="deptName"
        min-width="200"
      />
      <el-table-column
        :label="t('auto.views.crm.statistics.rank.components.ContactCountRank.k70b44dc3')"
        align="center"
        prop="count"
        min-width="200"
      />
...
const echartsOption = reactive<EChartsOption>({
  ...
  series: [
    {
      name: t('auto.views.crm.statistics.rank.components.ContactCountRank.kc5331573'),
      type: 'bar'
    }
  ],
  toolbox: {
  ...
  xAxis: {
    type: 'value',
    name: t('auto.views.crm.statistics.rank.components.ContactCountRank.k70b44dc3')
  },
  yAxis: {
    type: 'category',
    name: t('auto.views.crm.statistics.rank.components.ContactCountRank.k787ad1de')
  }
}) as EChartsOption
