      ...
      <el-col class="h-full overflow-auto" :span="19" :xs="24">
        ...
        >
          ...
          >
            ...
            <el-table-column label="用户名称" align="center" prop="account" width="150" />
            <el-table-column label="用户昵称" align="left" prop="name" min-width="150" />
...
import DeptTreeSelect from '@/views/system/user/DeptTree.vue'
...
const queryParams = reactive({
  pageNum: 1, // 页码
  pageSize: 10, // 每页条数
  account: undefined as string | undefined, // 用户名称
