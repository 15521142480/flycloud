<template>
  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px">
      ...
      <el-table-column
        :label="t('auto.views.erp.sale.out.components.SaleOutItemForm.k6f55a5a5')"
        min-width="125"
      >
        <template #default="{ row, $index }">
          ...
          >
            <el-select
              ...
              clearable
              filterable
              :placeholder="t('auto.views.erp.sale.out.components.SaleOutItemForm.k7aaa3bbb')"
...
const formRules = reactive({
  warehouseId: [
    {
      required: true,
      message: t('auto.views.erp.sale.out.components.SaleOutItemForm.k8a307436'),
      trigger: 'blur'
    }
  ],
  productId: [
    {
      required: true,
      message: t('auto.views.erp.sale.out.components.SaleOutItemForm.k0b3cde2b'),
      trigger: 'blur'
    }
  ],
  count: [
    {
      required: true,
      message: t('auto.views.erp.sale.out.components.SaleOutItemForm.k55ce5fbe'),
      trigger: 'blur'
    }
  ]
})
...
const getSummaries = (param: SummaryMethodProps) => {
  ...
  columns.forEach((column, index: number) => {
    if (index === 0) {
      sums[index] = t('auto.views.erp.sale.out.components.SaleOutItemForm.k92bcbf71')
      return
    }
