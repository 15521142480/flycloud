<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item
        :label="t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.k364bd1bf')"
        prop="name"
      >
        <el-input
          v-model="formData.name"
          :placeholder="t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.k010c1585')"
        />
      </el-form-item>
      <el-form-item
        :label="t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.kfe8aa4ef')"
        prop="sex"
      >
      ...
      <el-form-item
        :label="t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.ka1cd13bc')"
        prop="birthday"
      >
        <el-date-picker
          ...
          type="date"
          value-format="x"
          :placeholder="t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.ka38f2f3a')"
        />
      </el-form-item>
      <el-form-item
    ...
    <template #footer>
      <el-button @click="submitForm" type="primary" :disabled="formLoading">{{
        t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.k31f9d856')
      }}</el-button>
      <el-button @click="dialogVisible = false">{{
        t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.kd54aeadc')
      }}</el-button>
    </template>
  </Dialog>
</template>
...
const formRules = reactive({
  name: [
    {
      required: true,
      message: t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.k46f3776c'),
      trigger: 'blur'
    }
  ],
  sex: [
    {
      required: true,
      message: t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.k2b07e8d6'),
      trigger: 'blur'
    }
  ],
  birthday: [
    {
      required: true,
      message: t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.ke55ac24b'),
      trigger: 'blur'
    }
  ],
  description: [
    {
      required: true,
      message: t('auto.views.infra.demo.demo03.inner.Demo03StudentForm.k8803d8fa'),
      trigger: 'blur'
    }
  ]
})
