export default {
  ...
  common: {
    ...
    expand: '展開',
    confirmTitle: '系統提示',
    exportMessage: '是否確認導出數據項？',
    importMessage: '是否確認導入數據項？',
    createSuccess: '新增成功',
    updateSuccess: '修改成功',
    delMessage: '是否刪除所選中數據？',
    delDataMessage: '是否刪除數據？',
  ...
  login: {
    ...
    usernamePlaceholder: '請輸入賬號（默認賬號：admin）',
  ...
  system: {
    ...
    user: {
      ...
      password: '密碼',
      passwordInputPlaceholder: '請輸入用戶密碼',
      passwordRequired: '用戶密碼不能為空',
      newPassword: '新密碼',
      resetPassword: '重置密碼',
      assignRole: '分配角色',
      importTitle: '用戶導入',
      sex: '用戶性別',
      statusPlaceholder: '用戶狀態',
      passwordPlaceholder: '留空則不修改密碼',
      createTitle: '新增用戶',
      editTitle: '編輯用戶',
      resetPasswordPrompt: '請輸入 {account} 的新密碼',
      resetPasswordSuccess: '修改成功，新密碼是：{password}',
      passwordRule: '密碼長度為 6-32 位',
      deleteConfirm: '確認刪除用戶 {name}？',
      statusConfirm: '確認要"{action}""{account}"用戶嗎?',
      enableAction: '啟用',
      disableAction: '停用',
      exportFileName: '用戶數據.xls',
      uploadDragText: '將文件拖到此處，或',
      uploadClickText: '點擊上傳',
      updateSupport: '是否更新已經存在的用戶數據',
      importTip: '僅允許導入 xls、xlsx 格式文件。',
      downloadTemplate: '下載模板',
      uploadRequired: '請上傳文件',
      uploadFailed: '上傳失敗，請您重新上傳！',
      uploadLimit: '最多隻能上傳一個文件！',
      importCreateSuccessCount: '上傳成功數量：{count}',
      importUpdateSuccessCount: '更新成功數量：{count}',
      importUpdateFailedCount: '更新失敗數量：{count}',
      importTemplateFileName: '用戶導入模版.xls'
    },
    role: {
      title: '角色管理',
      add: '新增角色',
      ...
      editTitle: '編輯角色',
      menuPermission: '菜單授權',
      menuPermissionTitle: '菜單權限',
      allToggle: '全選/全不選',
      expandToggle: '全部展開/摺疊',
      yes: '是',
      no: '否',
      expand: '展開',
      collapse: '摺疊',
      savePermission: '保存授權',
      superAdminTip: 'super_admin 為超級管理員角色標識，登錄即擁有所有權限，可無需賦權',
      permissionRequired: '請至少選擇一項菜單或按鈕權限',
      permissionSaved: '授權已保存',
    ...
    menu: {
      ...
      deleteWithChildrenConfirm: '確認刪除 {name} 以及其下所有菜單？',
      deleteConfirm: '確認刪除菜單 {name}？',
      statusConfirm: '確認要{action}菜單 {name}？',
      enableAction: '啟用',
      disableAction: '停用',
      nameRequired: '菜單名稱不能為空',
      permissionRequired: '菜單權限不能為空',
      pathRequired: '路由地址不能為空',
    ...
    dict: {
      ...
      createDataTitle: '新增字典數據',
      editDataTitle: '編輯字典數據',
      deleteTypeConfirm: '確認刪除字典類型 {name}？',
      deleteDataConfirm: '確認刪除字典數據 {name}？'
    }
  },
  analysis: {
    newUser: '新增用戶',
