export default {
  ...
  system: {
    ...
    user: {
      ...
      phone: 'Mobile',
      phonePlaceholder: 'Please enter mobile',
      role: 'Role',
      ...
      editTitle: 'Edit User',
      resetPasswordPrompt: 'Please enter the new password for {account}',
      resetPasswordSuccess: 'Updated successfully. The new password is: {password}',
      passwordRule: 'Password length must be 6-32 characters',
      deleteConfirm: 'Delete user {name}?',
      statusConfirm: 'Confirm to {action} user "{account}"?',
      enableAction: 'enable',
      ...
      importTip: 'Only xls and xlsx files are allowed.',
      downloadTemplate: 'Download template',
      uploadRequired: 'Please upload a file',
      uploadFailed: 'Upload failed. Please upload again.',
      uploadLimit: 'Only one file can be uploaded.',
      importCreateSuccessCount: 'Created successfully: {count}',
  ...
  profile: {
    ...
    rules: {
      name: 'Please Enter User Nickname',
