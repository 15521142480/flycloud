...
export const createBrokerageUser = (data: any) => {
  return request.post({ url: `/${MALL_BASE_URL}/trade/brokerage-user/create`, data })
}

// 查询分销用户列表
export const getBrokerageUserPage = async (params: any) => {
  return await request.get<PageResult<BrokerageUserVO[]>>({
    url: `/${MALL_BASE_URL}/trade/brokerage-user/page`,
    params
  })
}
...
export const getBrokerageUser = async (id: number) => {
  return await request.get<BrokerageUserVO>({
    url: `/${MALL_BASE_URL}/trade/brokerage-user/get?id=` + id
  })
}

// 修改推广员
export const updateBindUser = async (data: any) => {
  return await request.put({ url: `/${MALL_BASE_URL}/trade/brokerage-user/update-bind-user`, data })
}

// 清除推广员
export const clearBindUser = async (data: any) => {
  return await request.put({ url: `/${MALL_BASE_URL}/trade/brokerage-user/clear-bind-user`, data })
}

// 修改推广资格
export const updateBrokerageEnabled = async (data: any) => {
  return await request.put({
    url: `/${MALL_BASE_URL}/trade/brokerage-user/update-brokerage-enable`,
    data
  })
}
