...
export const getDeliveryExpressPage = async (params: PageParam) => {
  return await request.get<PageResult<DeliveryExpressVO[]>>({
    url: `/${MALL_BASE_URL}/admin/trade/delivery/express/page`,
    params
  })
}
...
export const getSimpleDeliveryExpressList = () => {
  return request.get<DeliveryExpressVO[]>({
    url: `/${MALL_BASE_URL}/admin/trade/delivery/express/list-all-simple`
  })
}

// 新增快递公司
export const createDeliveryExpress = async (data: DeliveryExpressVO) => {
  return await request.post({ url: `/${MALL_BASE_URL}/admin/trade/delivery/express/create`, data })
}

// 修改快递公司
export const updateDeliveryExpress = async (data: DeliveryExpressVO) => {
  return await request.put({ url: `/${MALL_BASE_URL}/admin/trade/delivery/express/update`, data })
}
...
export const exportDeliveryExpressApi = async (params) => {
  return await request.download({
    url: `/${MALL_BASE_URL}/admin/trade/delivery/express/export-excel`,
    params
  })
}
