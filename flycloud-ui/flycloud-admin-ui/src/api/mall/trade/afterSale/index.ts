...
export interface TradeAfterSaleVO {
  ...
  orderId?: string | null // 交易订单编号
  orderNo?: string // 订单流水号
  orderItemId?: string | null // 交易订单项编号
  ...
  auditTime?: Date // 审批时间
  auditUserId?: string | null // 审批人
  auditReason?: string // 审批备注
  refundPrice?: number | null // 退款金额，单位：分。
  payRefundId?: string | null // 支付退款编号
  refundTime?: Date // 退款时间
  logisticsId?: string | null // 退货物流公司编号
