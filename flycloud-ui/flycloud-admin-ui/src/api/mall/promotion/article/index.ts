...
export const getArticlePage = async (params: any) => {
  return await request.get({ url: `/${MALL_BASE_URL}/admin/promotion/article/page`, params })
}
...
export const createArticle = async (data: ArticleVO) => {
  return await request.post({ url: `/${MALL_BASE_URL}/admin/promotion/article/create`, data })
}

// 修改文章管理
export const updateArticle = async (data: ArticleVO) => {
  return await request.put({ url: `/${MALL_BASE_URL}/admin/promotion/article/update`, data })
}
