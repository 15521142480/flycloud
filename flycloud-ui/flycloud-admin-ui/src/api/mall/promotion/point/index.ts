...
export const PointActivityApi = {
  ...
  getPointActivityPage: async (params: any) => {
    return await request.get({ url: `/${MALL_BASE_URL}/admin/promotion/point-activity/page`, params })
  },
  ...
  createPointActivity: async (data: PointActivityVO) => {
    return await request.post({ url: `/${MALL_BASE_URL}/admin/promotion/point-activity/create`, data })
  },

  // 修改积分商城活动
  updatePointActivity: async (data: PointActivityVO) => {
    return await request.put({ url: `/${MALL_BASE_URL}/admin/promotion/point-activity/update`, data })
  },
