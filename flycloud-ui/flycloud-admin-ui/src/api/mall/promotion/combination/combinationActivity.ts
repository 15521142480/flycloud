...
export const getCombinationActivityPage = async (params: any) => {
  return await request.get({ url: `/${MALL_BASE_URL}/admin/promotion/combination-activity/page`, params })
}
...
export const createCombinationActivity = async (data: CombinationActivityVO) => {
  return await request.post({
    url: `/${MALL_BASE_URL}/admin/promotion/combination-activity/create`,
    data
  })
}
...
export const updateCombinationActivity = async (data: CombinationActivityVO) => {
  return await request.put({ url: `/${MALL_BASE_URL}/admin/promotion/combination-activity/update`, data })
}
