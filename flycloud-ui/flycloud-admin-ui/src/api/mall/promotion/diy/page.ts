...
export const getDiyPagePage = async (params: any) => {
  return await request.get({ url: `/${MALL_BASE_URL}/admin/promotion/diy-page/page`, params })
}
...
export const createDiyPage = async (data: DiyPageVO) => {
  return await request.post({ url: `/${MALL_BASE_URL}/admin/promotion/diy-page/create`, data })
}

// 修改装修页面
export const updateDiyPage = async (data: DiyPageVO) => {
  return await request.put({ url: `/${MALL_BASE_URL}/admin/promotion/diy-page/update`, data })
}
...
export const updateDiyPageProperty = async (data: DiyPageVO) => {
  return await request.put({ url: `/${MALL_BASE_URL}/admin/promotion/diy-page/update-property`, data })
}
