...
// 删除学生课程
export const deleteDemo03Course = async (id: string) => {
  return await request.delete({ url: `/infra/demo03-student/demo03-course/delete/` + id })
}

// 获得学生课程
export const getDemo03Course = async (id: string) => {
...
// 删除学生班级
export const deleteDemo03Grade = async (id: string) => {
  return await request.delete({ url: `/infra/demo03-student/demo03-grade/delete/` + id })
}

// 获得学生班级
export const getDemo03Grade = async (id: string) => {
