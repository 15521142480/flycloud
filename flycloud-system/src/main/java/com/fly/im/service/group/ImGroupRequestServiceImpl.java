...
import com.fly.im.service.websocket.dto.notification.group.GroupRequestRejectedNotification;
...
public class ImGroupRequestServiceImpl implements ImGroupRequestService {
    ...
    private GroupRequestReceivedNotification buildRequestNotification(ImGroupDO group, ImGroupRequestDO request,
        ...
        if (applyUser != null) {
            payload.setUserNickname(applyUser.getName()).setUserAvatar(applyUser.getAvatar());
        }
        return payload;
    }
