...
import com.fly.system.api.im.domain.vo.ImChannelMessagePullVo;
...
public class ImChannelMessageController {
    ...
    public R<List<ImChannelMessagePullVo>> pull(
        ...
        return ok(BeanUtils.toBean(list, ImChannelMessagePullVo.class, vo -> {
