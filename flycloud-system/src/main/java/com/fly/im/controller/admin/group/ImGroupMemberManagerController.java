...
import com.fly.system.api.im.domain.vo.ImGroupMemberManagerVo;
...
public class ImGroupMemberManagerController {
    ...
    public R<List<ImGroupMemberManagerVo>> getGroupMemberList(@RequestParam("groupId") Long groupId) {
        // 1. 查询群全部成员（含已退群）
        ...
        // 2.2 转换为 VO，填充昵称、头像
        return ok(BeanUtils.toBean(members, ImGroupMemberManagerVo.class, vo ->
