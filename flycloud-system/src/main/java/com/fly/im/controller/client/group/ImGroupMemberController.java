...
import com.fly.system.api.im.domain.vo.ImGroupMemberVo;
...
public class ImGroupMemberController {
    ...
    public R<Boolean> updateGroupMember(@Valid @RequestBody ImGroupMemberBo updateReqVo) {
    ...
    public R<ImGroupMemberVo> getGroupMember(@RequestParam(value = "id", required = false) Long id,
        ...
        if (member == null) {
            return ok((ImGroupMemberVo) null);
        }
        ...
        // 3. 转化 VO
        ImGroupMemberVo memberVo = BeanUtils.toBean(member, ImGroupMemberVo.class);
    ...
    public R<List<ImGroupMemberVo>> getGroupMemberList(@RequestParam("groupId") Long groupId) {
        ...
        return ok(convertList(members, m -> {
            ImGroupMemberVo vo = BeanUtils.toBean(m, ImGroupMemberVo.class);
     ...
     */
    private void hidePrivateFieldsIfNotSelf(ImGroupMemberVo vo, Long memberUserId, Long loginUserId) {
