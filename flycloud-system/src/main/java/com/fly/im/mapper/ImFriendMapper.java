 ...
 * @date 2026-07-02
 */
public interface ImFriendMapper extends BaseMapperPlus<ImFriendMapper, ImFriend, ImFriendVo> {
    ...
    default PageResult<ImFriend> selectPage(ImFriendManagerPageBo reqVo) {
        return new PageResult<>(selectPage(reqVo.build(), new LambdaQueryWrapperX<ImFriend>()
