...
import com.fly.generator.mapper.GenTableMapper;
import com.fly.generator.service.IGenTableService;
import com.fly.generator.util.GenUtils;
import com.fly.generator.util.VelocityInitializer;
import com.fly.generator.util.VelocityUtils;
...
//            List<GenTableColumn> genTableColumns = genTableColumnMapper.selectDbTableColumnsByName(tableName, isBlank(GenConfig.getSchemaName()) ? "public" : GenConfig.getSchemaName());
