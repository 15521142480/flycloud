...
public class DeliveryExpressTemplateController extends BaseController {
    ...
    public R<Void> saveOrUpdate(@RequestBody DeliveryExpressTemplateBo bo) {
        return R.result(deliveryExpressTemplateService.saveOrUpdate(bo));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空") @PathVariable Long[] ids) {
        return R.result(deliveryExpressTemplateService.deleteWithValidByIds(Arrays.asList(ids), true));
    }
    ...
    public R<Void> yudaoDelete(@RequestParam("id") Long id) {
        return R.result(deliveryExpressTemplateService.deleteWithValidByIds(java.util.List.of(id), true));
    }
