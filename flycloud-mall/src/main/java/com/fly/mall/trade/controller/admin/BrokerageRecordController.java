...
public class BrokerageRecordController extends BaseController {
    ...
    public R<Void> saveOrUpdate(@RequestBody BrokerageRecordBo bo) {
        return R.result(brokerageRecordService.saveOrUpdate(bo));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空") @PathVariable Long[] ids) {
        return R.result(brokerageRecordService.deleteWithValidByIds(Arrays.asList(ids), true));
    }
    ...
    public R<Void> yudaoDelete(@RequestParam("id") Long id) {
        return R.result(brokerageRecordService.deleteWithValidByIds(java.util.List.of(id), true));
    }
