...
import com.fly.mall.api.domain.trade.BrokerageRecord;
import com.fly.mall.api.domain.trade.bo.BrokerageRecordBo;
import com.fly.mall.api.domain.trade.vo.BrokerageRecordVo;
...
public class BrokerageRecordServiceImpl extends BaseServiceImpl<BrokerageRecordMapper, BrokerageRecord> implements IBrokerageRecordService {
    ...
    public Boolean deleteWithValidByIds(Collection<Long> ids, Boolean isValid) {
        for (Long id : ids) {
            BrokerageRecord entity = new BrokerageRecord();
            entity.setId(id);
