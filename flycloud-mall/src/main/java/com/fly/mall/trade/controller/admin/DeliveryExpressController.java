...
public class DeliveryExpressController extends BaseController {
    ...
    public R<Void> saveOrUpdate(@RequestBody DeliveryExpressBo bo) {
        return R.result(deliveryExpressService.saveOrUpdate(bo));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空") @PathVariable Long[] ids) {
        return R.result(deliveryExpressService.deleteWithValidByIds(Arrays.asList(ids), true));
    }
    ...
    public R<Void> yudaoDelete(@RequestParam("id") Long id) {
        return R.result(deliveryExpressService.deleteWithValidByIds(java.util.List.of(id), true));
    }
