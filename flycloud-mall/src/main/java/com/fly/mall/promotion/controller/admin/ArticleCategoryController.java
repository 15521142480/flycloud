...
public class ArticleCategoryController extends BaseController {
    ...
    public R<Void> saveOrUpdate(@RequestBody ArticleCategoryBo bo) {
        return R.result(articleCategoryService.saveOrUpdate(bo));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空") @PathVariable Long[] ids) {
        return R.result(articleCategoryService.deleteWithValidByIds(Arrays.asList(ids), true));
    }
    ...
    public R<Void> yudaoDelete(@RequestParam("id") Long id) {
        return R.result(articleCategoryService.deleteWithValidByIds(java.util.List.of(id), true));
    }
