...
public class SeckillProductController extends BaseController {
    ...
    public R<Void> saveOrUpdate(@RequestBody SeckillProductBo bo) {
        return R.result(seckillProductService.saveOrUpdate(bo));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空") @PathVariable Long[] ids) {
        return R.result(seckillProductService.deleteWithValidByIds(Arrays.asList(ids), true));
    }
    ...
    public R<Void> yudaoDelete(@RequestParam("id") Long id) {
        return R.result(seckillProductService.deleteWithValidByIds(java.util.List.of(id), true));
    }
