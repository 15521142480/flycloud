...
import com.fly.mall.api.domain.product.bo.ProductFavoriteBo;
import com.fly.mall.api.domain.product.vo.ProductFavoriteVo;
...
public class AppProductFavoriteController {
     ...
     */
    @GetMapping("/page")
    public R<PageVo<ProductFavoriteVo>> getFavoritePage(ProductFavoriteBo bo, PageBo page) {
        return R.ok(productFavoriteService.queryUserFavoritePage(UserUtils.getCurUserId(), bo, page));
    }
