...
public class JacksonConfig {
    ...
    public JsonUtils jsonUtils(List<ObjectMapper> objectMappers) {
        ...
        simpleModule
                ...
                .addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateUtils.DATETIMEFORMATTER))
                .addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateUtils.DATETIMEFORMATTER));
