package com.fly.common.database.service.impl;
...
import com.fly.common.database.interceptor.DataScope;
import com.fly.common.database.service.BaseService;
...
public class BaseServiceImpl<M extends BaseMapper<T>, T> extends ServiceImpl<M, T> implements BaseService<T> {
     ...
     * @param query 分页参数
     */
    public IPage<T> buildIPage(PageDto query) {
...
//        }
     ...
     * 构建分页vo泛型
     */
    public <T> PageVo<T> buildPageVo(IPage<T> page) {
