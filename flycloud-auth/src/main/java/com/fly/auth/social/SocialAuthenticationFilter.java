...
import com.fly.common.enums.MethodType;
...
public class SocialAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	 ...
	 * 请求中的参数
	 */
	private String socialParameter = Oauth2Constants.DEFAULT_PARAMETER_NAME_SOCIAL;
	...
	// return new AuthCallback(this.code, this.auth_code, this.state, this.authorization_code, this.oauthToken, this.oauthVerifier);
	/**
	 * 从请求中构建 AuthCallback
	 */
	private AuthCallback getCallback(HttpServletRequest request) {
		...
		AuthCallback authCallback = AuthCallback.builder()
				...
				.oauthToken(request.getParameter("oauth_token")) // oauthToken
				.oauthVerifier(request.getParameter("oauth_verifier")) // oauthVerifier
				.build();
